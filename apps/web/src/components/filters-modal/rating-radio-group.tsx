...
const RatingRadioGroup = React.forwardRef<HTMLDivElement, RatingRadioGroupProps>(({ className, label, hideStarsText, ...props }, ref) => {
  ...
  return (
    <div className={cn('flex items-center gap-3', className)}>
      <RadioGroup ref={ref} value={value} {...props} defaultValue="1" orientation="horizontal" onValueChange={setValue}>
