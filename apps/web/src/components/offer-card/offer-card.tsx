...
const PlaceListItem = React.forwardRef<HTMLDivElement, PlaceListItemProps>(
  ({ name, price, rating, isLoading, description, imageSrc, removeWrapper, className, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <Image isBlurred isZoomed alt={name} className="aspect-square w-full hover:scale-110" isLoading={isLoading} src={imageSrc} />
        ...
        <div className="mt-1 flex flex-col gap-2 px-1">
          {isLoading ? (
            ...
            <>
              ...
              <p className="text-small font-medium text-default-500">{price} zł/godz</p>
            </>
          )}
        </div>
      </div>
